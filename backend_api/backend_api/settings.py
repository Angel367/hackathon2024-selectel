...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'backend_api.exceptions.core_exception_handler',
    'NON_FIELD_ERRORS_KEY': 'error',
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'backend_api_app.backends.JWTAuthentication',
    )
}
...
AUTHENTICATION_BACKENDS = [
    'backend_api_app.backends.EmailPhoneAuthBackend',
